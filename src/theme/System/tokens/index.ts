...
export type { SystemBorderRadius, SystemBorderRadiusMap } from './border';
export { default as borderRadius } from './border';

export type { SystemColorPalette } from './colorPalette';
